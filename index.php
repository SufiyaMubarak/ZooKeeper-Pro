...
<html>
<head>
<title>ZooKeeper Pro | Home Page</title>
			...
			<div class="header-banner">
				<div class="container">
					<div class="head-banner">
						<h3>WildScape Zoo</h3>
						<p> "Welcome to WildScape Zoo ! Experience the magic of wildlife
						and join us in our mission to protect and conserve these magnificent creatures."
						 </p>
					</div>
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>Precautions</h4>
							<p>"Please Stay on the designated".
							"Do not feed the animals"."Avoid loud noises"</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>Beauty of Zoo</h4>
							<p>The Natural beauty of our zoo makes it a favorite destination.</p>
						</div>
